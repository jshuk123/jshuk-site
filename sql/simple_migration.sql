-- Simple Migration Script for Ads Table
-- This script creates a fresh ads table with the new structure

-- Disable foreign key checks
SET FOREIGN_KEY_CHECKS = 0;

-- Create backup of existing ads table (if it exists)
CREATE TABLE IF NOT EXISTS `ads_backup_old` AS SELECT * FROM `ads`;
...
SELECT COUNT(*) as 'Total ads created' FROM `ads`; 