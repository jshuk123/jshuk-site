...
try {
    ...
    if ($has_new_columns) {
        // Use the new query with categories
        $stmt = $pdo->prepare("
        ...
        // Use the old simple query
        $stmt = $pdo->prepare("SELECT * FROM classifieds $where_sql ORDER BY created_at DESC");
    }
    ...
    <div class="container">
      <div class="section-header">
        <h2 class="section-title">
          <?php if ($has_new_columns && isset($_GET['category']) && $_GET['category'] === 'free-stuff'): ?>
            ♻️ Free Stuff & Chessed Giveaways
          <?php elseif ($has_new_columns && isset($_GET['free_only']) && $_GET['free_only'] == '1'): ?>
            🆓 Free Items Only
          <?php else: ?>
            Latest Classifieds
          <?php endif; ?>
            ...
            <div class="classified-card-wrapper">
              <div class="classified-card">
                <div class="classified-image">
                  ...
                  <?php endif; ?>
                  <?php if ($has_new_columns && isset($c['is_chessed']) && $c['is_chessed']): ?>
                    <span class="badge-chessed">💝 Chessed</span>
                  <?php endif; ?>
                  <?php if ($has_new_columns && isset($c['is_bundle']) && $c['is_bundle']): ?>
                ...
                <div class="classified-content">
                  ...
                  <?php if ($has_new_columns && isset($c['category_name']) && $c['category_name']): ?>
                  ...
                  <div class="classified-meta">
                    ...
                    <?php if ($has_new_columns && $c['price'] == 0 && isset($c['pickup_method']) && $c['pickup_method']): ?>
                    ...
                    <?php endif; ?>
                    <?php if ($has_new_columns && $c['price'] == 0 && isset($c['status']) && $c['status']): ?>
